...
/**
 * This is the model class for table "tbl_city_partner_plans".
 *
 * The followings are the available columns in table 'tbl_city_partner_plans':
 ...
 */
class CityPartnerPlans extends CActiveRecord
{
	/**
	...
	{
		return TABLE_CITY_PARTNER_PLANS;
	}
	 ...
	 * @return CityPartnerPlans the static model class
	 */
