...
class CityPartners extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('cityPartnerFirstName, cityPartnerLastName, cityPartnerMobile, cityPartnerBusinessName,  cityPartnerAddress, cityPartnerCity, cityPartnerState, cityPartnerCountry, cityPartnerOperationCity, cityPartnerOperationState, cityPartnerOperationCountry, cityPartnerOperationArea, cityPartnerZip', 'required', 'on'=>'city_partner_create_front'),
