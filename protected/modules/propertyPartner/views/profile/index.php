	...
	<div class="full-box">
		<div class="membership-plan-outer">
			...
			<div class="member-create-account">
				...
				<?php  
					if( Yii::app()->User->hasFlash('updatePropertyPartnerSuccess')){ 
						if(Yii::app()->User->getFlash('updatePropertyPartnerSuccess'))
						{
				...
				<div class="dashboard-menu-outerbox">
					...
					<div class="dashboard-heading">
							...
							<div class="dashboard-profile">
								<?php if((Yii::app()->user->propertyPartnerSubscriptionPlan) == '1' ){ ?>
								<div class="membership-plan-upgrade border-bottom-outer">
									<div class="city-membership-plan">
										<?php echo CHtml::link('Upgrade Membership Plan', array('/payment/paymentPage', 'memberID'=>$model->pkPropertyPartnerID),array('class' => 'upfrade-plan-btn')); ?>
									<!-- <a href="#" class="upfrade-plan-btn">Upgrade Membership Plan</a> -->
										Current Membership Plan  - <span class="dashboard-plan-type">Free</span>									
									</div>
								</div>
								<?php }else if((Yii::app()->user->propertyPartnerSubscriptionPlan) == '2') { ?>
								<div class="membership-plan-upgrade border-bottom-outer">
									<div class="city-membership-plan">
										<?php echo CHtml::link('Upgrade Membership Plan', array('/payment/paymentPage', 'memberID'=>$model->pkPropertyPartnerID),array('class' => 'upfrade-plan-btn')); ?>
									<!-- <a href="#" class="upfrade-plan-btn">Upgrade Membership Plan</a> -->
							...
							<ul class="acc-login">
								...
								<li>
									<div class="half-input">
										<?php echo $form->textField($model,'propertyPartnerFirstName',array('class'=>'requiredField','placeholder'=>'First Name')); ?>	
										<?php echo $form->error($model, 'propertyPartnerFirstName'); ?>
									</div>
									<div class="half-input">
										<?php echo $form->textField($model,'propertyPartnerLastName',array('class'=>'requiredField','placeholder'=>'Last Name')); ?>	
										<?php echo $form->error($model, 'propertyPartnerLastName'); ?>
									</div>
									<div class="half-input margin0">	
										<?php echo $form->textField($model,'propertyPartnerMobile',array('class'=>'requiredField phoneField','placeholder'=>'Mobile')); ?>	
								...
								<li>
									<div class="half-input date-cal">
										<?php
											$this->widget('zii.widgets.jui.CJuiDatePicker', array(
											 ...
											 echo $form->error($model, 'propertyPartnerDateOfBirth');
											?>
									</div>
									<!-- <div class="half-input date-cal">
									...
									<div class="half-input">
										<?php echo $form->textField($model,'propertyPartnerBusinessName',array('class'=>'requiredField','placeholder'=>'BUsiness Name')); ?>	
							...
							<li>
								<div class="half-input">
										<div class="slecet-country">
											  <div class="half-half-input">
											  <?php echo $form->dropDownList($model,'propertyPartnerCity',$model->cityOptions,array('empty'=>'- Select City -','class'=>'chosen-select half-input dropdown requiredField','id'=>'partnerCity')); ?>	
											  <?php echo $form->error($model, 'propertyPartnerCity'); ?>
											  </div>
											  <div class="half-half-input margin0">
												<?php echo $form->textField($model,'propertyPartnerZip',array('class'=>'requiredField zipField','data-rule-required'=>'true','placeholder'=>'Zip')); ?>	
								  				<?php echo $form->error($model, 'propertyPartnerZip'); ?>
											  </div>
										  </div>
									</div>
									<div class="onesecond-input margin0">
												<?php echo $form->textField($model,'propertyPartnerAddress',array('class'=>'requiredField','data-rule-required'=>'true','placeholder'=>'Address')); ?>	
								  				<?php echo $form->error($model, 'propertyPartnerAddress'); ?>
									</div>
							</li>
							<li>
								<div class="half-input">
									<?php echo $form->textField($model,'propertyPartnerWebsite',array('class'=>'requiredField','placeholder'=>'Website')); ?>	
									<?php echo $form->error($model, 'propertyPartnerWebsite'); ?>
								</div>
								<div class="half-input">								
											  	<?php echo $form->dropDownList($model,'propertyPartnerContactMethod',
																	array(
																		'empty'=>'- Select Mode -',
																		'1' => 'Mobile',
																		'2' => 'E-Mail',
																	...
																	array('class' =>'chosen-select requiredField', 'id'=>'propertyPartnerContactMethod')
																	); ?>
